...
class SimulationManager {
    ...
    init() {
        ...
        // Carro inicia en LaneBackward: primer waypoint (95, -97.5), mirando al Oeste (-X)
        this.car = new Car(this.scene, 95.0, -97.5);
        this.car.angle = -Math.PI / 2; // Mirando hacia -X (Oeste)
        ...
        const onKeyDown = (e) => {
            ...
            switch(e.code) {
                ...
                case 'KeyC':
                    ...
                    break;
                case 'KeyP':
                    // Atajo de piloto automático (toggle)
